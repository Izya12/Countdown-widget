...
1. [ ] Утвердить ID в исходниках и проверить новый пакет тестами.
2. [ ] Подготовить свободный toolchain и перечень runtime-зависимостей/лицензий.
3. [ ] Добавить описания, иконку и реальные скриншоты RU/EN в Fastlane metadata.
4. [ ] Добавить политику конфиденциальности и канал обратной связи.
